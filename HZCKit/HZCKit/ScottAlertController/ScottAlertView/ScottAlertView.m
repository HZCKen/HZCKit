...
- (instancetype)initWithTitle:(NSString *)title message:(NSString *)message {
    if (self = [super init]) {
        ...
        [self addTextLabelsWithTitle:title message:message];
...
- (void)configureProperty {
    ...
    _buttonCornerRadius = 0.0;
    _buttonFont = [UIFont fontWithName:@"HelveticaNeue-Bold" size:17];
    //[UIColor colorWithRed:52/255.0 green:152/255.0 blue:219/255.0 alpha:1];
...
- (UIColor *)buttonBgColorWithStyle:(ScottAlertActionStyle)style {
    switch (style) {
        ...
        case ScottAlertActionStyleNone:
...
- (void)addContentViews
{
    ...
    buttonContentView.backgroundColor = [UIColor groupTableViewBackgroundColor];
    UIView *lightv = [[UIView alloc]initWithFrame:CGRectMake(0, -0.5, 300, 0.5)];
    lightv.backgroundColor = [UIColor groupTableViewBackgroundColor];
    [buttonContentView addSubview:lightv];
...
- (void)addTextLabelsWithTitle:(NSString *)title message:(NSString *)message
{
    if (title.length > 0) {
...
- (void)addAction:(ScottAlertAction *)action
{
    ...
    button.backgroundColor = [UIColor whiteColor];//[self buttonBgColorWithStyle:action.style];
...
//- (void)addGenderTextFieldWithConfigurationHandler:(void (^)(Gender *textField))handler
//{
//    if (_textFields == nil) {
//        _textFields = [NSMutableArray array];
//    }
//    
//    Gender *textField = [[Gender alloc]init];
//    textField.tag = kTextFieldOffset + _textFields.count;
//    textField.font = _textFieldFont;
//    textField.translatesAutoresizingMaskIntoConstraints = NO;
//    
...
- (void)layoutTextLabels {
    ...
    if ([_textContentView.subviews containsObject:_titleLable]) {
        // title
        _titleLable.translatesAutoresizingMaskIntoConstraints = NO;
        
        if ([_textContentView.subviews containsObject:_messageLabel]) {
            ...
            [_textContentView scott_addConstraintWithView:_titleLable topView:_textContentView leftView:_textContentView bottomView:_textContentView rightView:_textContentView edgeInset:UIEdgeInsetsZero];
        }
    ...
    if ([_textContentView.subviews containsObject:_messageLabel]) {
        ...
        if ([_textContentView.subviews containsObject:_titleLable]) {
            ...
            [_textContentView scott_addConstraintWithView:_messageLabel topView:_textContentView leftView:_textContentView bottomView:_textContentView rightView:_textContentView edgeInset:UIEdgeInsetsZero];
        }
...
- (void)layoutButtons {
    ...
    if (_buttons.count == 1) {
        ...
        [_buttonContentView scott_addConstraintWithLeftView:firstButton toRightView:button constant:1];
